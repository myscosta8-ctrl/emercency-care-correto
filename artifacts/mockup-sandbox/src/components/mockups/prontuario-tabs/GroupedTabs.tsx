...
const GROUPS = [
  ...
  },
  {
    ...
    icon: "🏥",
    label: "Internação",
    desc: "Admissão · Entrada",
    color: "#f59e0b",
    tabs: [
      { id: "admissao-medica", label: "Admissão Médica", icon: "👨‍⚕️", note: "médico" },
      { id: "plano-terapeutico", label: "Plano Terapêutico", icon: "📋", note: "médico" },
      { id: "aih", label: "↓ AIH (PDF)", icon: "📄", note: "médico · ação" },
      { id: "admissao-enf", label: "Admissão de Enfermagem", icon: "💉", note: "enfermeiro" },
      { id: "vitais", label: "Sinais Vitais", icon: "❤️", note: "enfermeiro" },
      { id: "plano-cuidados", label: "Plano de Cuidados", icon: "📊", note: "enfermeiro" },
      { id: "alergias", label: "Alergias", icon: "⚠️" },
      { id: "tcle", label: "TCLE", icon: "✍️" },
      { id: "obito", label: "Óbito", icon: "💀", danger: true },
    ],
  },
  {
    id: "evolucao",
    icon: "🩺",
    label: "Evolução",
    desc: "Todos · Multiprofissional",
    color: "#8b5cf6",
    tabs: [
      { id: "medico", label: "Evol. Médica", icon: "👨‍⚕️" },
      { id: "enfermagem", label: "Enfermagem", icon: "💉" },
      { id: "sae", label: "SAE", icon: "📊" },
      { id: "tecnico", label: "Anotação Enf.", icon: "🩹" },
  ...
  },
  {
    ...
    tabs: [
      ...
      { id: "sol-exames", label: "Sol. Exames", icon: "🔬" },
      ...
      { id: "med-controlados", label: "Med. Controlados", icon: "📋" },
      { id: "dispensacao", label: "Dispensação Farm.", icon: "🏷️" },
    ],
  },
];
...
const CONTENT_PLACEHOLDERS: Record<string, { title: string; body: string }> = {
  ...
  "admissao-medica": {
    title: "Admissão Médica",
    body: "Avaliação clínica de entrada: HDA, exame físico, hipótese diagnóstica, CID-10, conduta inicial, CRM. Documento de entrada do paciente para internação.",
  },
  "plano-terapeutico": {
    title: "Plano Terapêutico",
    body: "Prescrição inicial de internação: medicamentos, dieta, cuidados de enfermagem, metas clínicas e plano de alta previsto.",
  },
  aih: {
    title: "AIH — Autorização de Internação Hospitalar",
    body: "Geração do PDF da AIH com dados do paciente preenchidos automaticamente. Documento SUS obrigatório para internação hospitalar.",
  },
  "admissao-enf": {
    title: "Admissão de Enfermagem (SAE)",
    body: "Avaliação inicial de enfermagem: histórico, exame físico de enfermagem, diagnósticos NANDA, prescrição inicial de enfermagem. Documento de entrada do enfermeiro.",
  },
  "plano-cuidados": {
    title: "Plano de Cuidados",
    body: "Plano estruturado de cuidados de enfermagem: metas, intervenções, frequência de avaliação, resultados esperados e reavaliações.",
  },
  alergias: {
    title: "Alergias",
    body: "Registro de alergias medicamentosas e alimentares com gravidade, reação descrita e data de identificação.",
  },
  interconsulta: {
    title: "Interconsulta",
    body: "Solicitação e resposta de interconsulta entre especialidades. Motivo da solicitação, especialidade consultada e parecer recebido.",
  },
  "sol-exames": {
    title: "Solicitação de Exames",
    body: "Solicitar exames laboratoriais e de imagem com prioridade, justificativa clínica e status de realização.",
  },
  "med-controlados": {
    title: "Medicamentos Controlados",
    body: "Registro e controle de psicotrópicos e outras substâncias controladas com receituário especial.",
  },
  dispensacao: {
    title: "Dispensação Farmacêutica",
    body: "Controle de dispensação de medicamentos pela farmácia com conferência de prescrições e registro de entrega.",
  },
};
